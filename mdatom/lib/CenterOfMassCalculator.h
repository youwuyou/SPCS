...
public:
    explicit CenterOfMassCalculator(bool calculateCMPosition = true, bool calculateCMTranslation = true);

    void update(int numberAtoms, const std::vector<double> &positions, const std::vector<double> &velocities,
                double atomicMass);
